...
THE PROTOCOL
   ...
   connection, otherwise you must now send a USER command.
     ...
     2. USER user-id, ACCT account, PASS password
/**{	  
	  2.1 USER user-id
		{
         ...
         The reply to this command will be one of:
            ...
            !<user-id> logged in
               ...
               Meaning you dont need an account or password or you
      ...
      2.3 PASS password
		{
         ...
         Valid replies are:
            ...
            +Send account
               ...
               Password ok but you havent specified the account.
 ...
 * {
         ...
         Replies are:
            ...
            -Cant connect to directory because: (reason)
...
/**{
         ...
         Replies:
            ...
            -Cant find <old-file-spec>

               NAME command is aborted, dont send TOBE.
         ...
         The server replies with:
            ...
            -File wasnt renamed because (reason)
}
*/
     8. DONE
/**
...
*/
     10. STOR { NEW | OLD | APP } file-spec
/**
{ EX: STOR OLD filename.txt
         ...
         "not delete" the existing one.
            ...
            Replies could be:
               ...
               -File exists, but system doesnt support generations
         ...
         on the remote site.  If the file doesnt exist it will be
         created.
         ...
         The remote system replies:
            ...
            +ok, waiting for file
               ...
               When you are done the remote system should reply:
                  ...
                  -Couldnt save because (reason)

            -Not enough room, dont send it
...
12. EDITORS NOTE
{
   ...
   and resolution for each.
      ...
      Additional Modes
         ...
         Pro:  For some machines you cant send all the bits in a word
      ...
      Random Access
         ...
         Pro:  Wouldnt it be nice if (WIBNIF) SFTP had a way of
         accessing parts of a file?

         Con:  Forget it, this is supposed to be SIMPLE file transfer.
         If you need random access use real FTP (oops, real FTP doesnt
