 ...
 * @param request field or associated file name
 * @return boolean returns TRUE on success or FALSE on failure.
 */
...
/**
 * Reads binary data from a BLOB field type This function applies to SELECT type (i5_queryi5_query or i5_executei5_execute) requests containing one or more BLOB type fields. Note: Reading and writing a blob requires a transaction.
 ...
 * @param stmt resource Pi5_prepare prepared request ID
